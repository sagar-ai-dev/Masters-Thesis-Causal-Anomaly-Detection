"""
==============================================================
 Target-Wise GES Robotics Anomaly Detection: RBF + Ridge
==============================================================

Purpose
-------
This standalone PCMCI-style script runs the target-wise GES anomaly-detection pipeline with RBF random Fourier features and Ridge regression. It uses the same fixed GES graph, preprocessing, cache behavior, thresholding style, and metric formulas as the Linear and Polynomial scripts.
...
parent-lag design matrix X and the current target value is y.
    ...
    params  = gamma = 0.001, n_components = 100, ridge_alpha = 1.0, random_state = 42, threshold_multiplier = 1.8
