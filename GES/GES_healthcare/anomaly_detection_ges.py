"""
==============================================================
 Target-Wise GES Healthcare Anomaly Detection: Linear / Ridge
==============================================================

Purpose
-------
This standalone PCMCI-style script runs the final selected target-wise GES anomaly-detection pipeline with ridge-regularized linear regression on the PTB-XL healthcare ECG dataset. It contains the complete pipeline directly in this file, including data loading, target-wise GES, graph caching, coefficient fitting, anomaly scoring, metrics, plotting, and main().
...
parent-lag design matrix X and the current target value is y.
    ...
    params  = threshold_multiplier = 3.0, ridge_alpha = 10.0
...
def ensure_canonical_ges_graph() -> Path:
    ...
    Cache behavior:
    - If Healthcare dataset/healthcare_normal_ges.npz exists, reuse the fixed GES graph.
